package com.example.ecommerce_platform.common;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/e_commerce_platform?characterEncoding=utf8&useSSL=false");
                // dsc.setSchemaName("public");
                dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("wangtao");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        // ⼆、模块配置
        pc.setParent("com.example.ecommerce_platform")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
